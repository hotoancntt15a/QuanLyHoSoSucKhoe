    ...
    public static class buildDatabase
    {
        ...
        public static string createDatabase()
        {
            ...
            try
            {
                ...
                if (tables.Contains("dmbenhvien") == false) { tsql.Add("create table dmbenhvien (id nvarchar(20) not null primary key, matinh nvarchar(10) not null, mabv nvarchar(10) not null, ten nvarchar(255) not null, diachi nvarchar(255) not null default '', sothe nvarchar(255) not null default '', doituongkcb nvarchar(255) not null default '', mahuyen nvarchar(10) not null default '', dunghoatdong nvarchar(10) not null default '');"); }
